...
const PostJob = () => {
 ...
 const onSubmit = (data) => { 
  ...
  .then(result => {
    console.log(result);
    // Check for specific success property
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
          ...
          <div className='create-job-flex'>
            ...
            <div className='lg:w-1/2 w-full'>
              ...
              <input type="text" placeholder='$10000K'
          ...
          <div className='create-job-flex'>
            <div className='lg:w-1/2 w-full'>
              ...
              <input type="date" placeholder='2024-11-03'
          ...
          <div>
            ...
            <CreatableSelect
              ...
              value={selectedOption} // Bind value to selectedOption
        ...
        {/* 6th row */}
         <div className='create-job-flex'>
            <div className='lg:w-1/2 w-full'>
              ...
              <input type="url" 
              placeholder='Paste your company logo URL: https://www.goojara.to/img/logo.png'
